...
public class ViewComments_Two extends AppCompatActivity {
    String email = "";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_comments__two);
    ...
    public void btnAddComment_OnClick(View v) {
        Intent i = new Intent(this, LeaveCommentTwo.class);
    ...
    public void displayComments() {
        ...
        arrayComments = db.getcomments("Kelvingrove"); //put in the name of the place here
