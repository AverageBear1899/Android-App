...
public class LeaveCommentTwo extends AppCompatActivity {
    String email = "";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leave_comment_two);
    ...
    public void btnSave_OnClick(View v)
    {
        ...
        comments.setPlaceId("Kelvingrove");
        ...
        Intent i = new Intent (this, ViewComments_Two.class);
