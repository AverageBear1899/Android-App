...
public class ViewComments_One extends AppCompatActivity {
    String email = "";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_comments__one);
        //get the last intent and get the username extra from it
        Intent i = getIntent();
        email = i.getStringExtra("email");

        //call the display comments method
        displayComments();
    }
    ...
    {
        Intent i = new Intent(this, LeaveCommentOne.class);
    ...
    {
        //find the list view
        ListView listOfComments = (ListView) findViewById(R.id.lstComment);
        ...
        arrayComments = db.getcomments("Glasgow Cathedral"); //put in the name of the place here
