...
public class LeaveCommentThree extends AppCompatActivity {
    String email = "";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_leave_comment_three);
        Intent i = getIntent();
    ...
    public void btnSave_OnClick(View v) {
        ...
        Intent i = new Intent(this, ViewComments_Three.class);
